        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('friends.request.show')">
                                ➕ Add Friends
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('friends.request.incoming')">
                                📨 Incoming Requests
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('friends.request.index')">
                                👫 View All Friends
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <x-slot name="trigger">
                        <button
                            ...
                            <span id="notify-count"
                                  class="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-xs rounded-full px-1.5 {{ $unread ? '' : 'hidden' }}">
                                {{ $unread }}
                            </span>
                        </button>
                    </x-slot>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.info', ['user' => Auth::user()->name])">
                            {{ __('Profile') }}
                        </x-dropdown-link>
