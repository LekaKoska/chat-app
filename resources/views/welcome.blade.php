        ...
        <section class="container">
            <div class="mb-10">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                    Place where you can make new friends, chat in real-time, participate in discussions, vote for your favourite posts, and follow your friends' activity.
                </p>
            </div>
            ...
            <div class="mt-16 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-indigo-600 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h8m-6 8l-5-5H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-1l-5 5z" />
                    </svg>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.29-.9L3 20l1.1-4.71A8.963 8.963 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                    <h3 class="text-2xl font-semibold mb-2 text-gray-900 dark:text-white">Discussions</h3>
                    <p class="text-gray-600 dark:text-gray-300">Create topics, participate in conversations, and share opinions.</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-pink-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 8a6 6 0 11-12 0 6 6 0 0112 0zM2 20a6 6 0 0112 0H2zM14 14h8" />
                    </svg>
            ...
            <div class="mt-16">
                <p class="text-gray-600 dark:text-gray-400 mb-4">Are you ready to start new friendships and explore the app?</p>
                <a href="{{ Auth::user() ? route('posts.index') : route('register') }}" class="px-6 py-3 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition">Start now</a>
            </div>
        </section>
    </main>
</body>
