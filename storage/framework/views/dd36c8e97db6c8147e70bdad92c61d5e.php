...
<head>
    ...
    <?php if(auth()->check()): ?>
        <script>window.auth = {user: {id: <?php echo e(auth()->id()); ?>, name: <?php echo json_encode(auth()->user()->name, 15, 512) ?> }};</script>
    <?php endif; ?>
    <style>
        .container {
            max-width: 1200px;
    ...
    <section class="container">
        ...
        <div class="mt-16">
            <p class="text-gray-600 dark:text-gray-400 mb-4">Are you ready to start new friendships and explore the
                app?</p>
            <a href="<?php echo e(Auth::user() ? route('posts.index') : route('register')); ?>"
...
<?php /**PATH C:\Users\alekk\Desktop\PROJEKTI\chat-app\resources\views/welcome.blade.php ENDPATH**/ ?>