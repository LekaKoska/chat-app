...
<?php $component->withAttributes(['align' => 'right','width' => '80']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button
                            class="relative inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-gray dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <span id="notify-count"
                                  class="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-xs rounded-full px-1.5 <?php echo e($unread ? '' : 'hidden'); ?>">
                                <?php echo e($unread); ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <div class="overflow-y-auto max-h-96" id="notify-list">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <form id="notify-form-<?php echo e($notification->id); ?>"
                                      action="<?php echo e(route('notification.read', $notification->id)); ?>"
                                      method="POST"
                                      class="border-b border-gray-200 dark:border-gray-700">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <a href="<?php echo e($notification->data['url']); ?>"
                                       onclick="event.preventDefault(); document.getElementById('notify-form-<?php echo e($notification->id); ?>').submit();"
                                       class="block px-4 py-2 flex items-center space-x-3 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                                        <img
                                            src="<?php echo e("/storage/images/avatars/{$notification->data['sender']['avatar']}"); ?>"
                                            alt="avatar"
                                            class="w-10 h-10 rounded-full border border-gray-300 object-cover">
                                        <span class="text-sm text-gray-800 dark:text-gray-200">
                            <?php echo e($notification->data['notification']); ?>
                            ...
                            <?php if(\auth()->user()->notification !== null): ?>
                                    <a href="<?php echo e(route('notification.read.all')); ?>">Read all</a>
                            <?php endif; ?>
...
<?php endif; ?>
                <div x-data="{ open: false }" class="relative inline-block">
                    <button @click="open = !open"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800 dark:text-gray-200"
                        ...
                        <span id="message-count"
                              class="absolute -top-0.5 -right-0.5 bg-green-600 text-white text-xs rounded-full px-1.5 hidden">
                            <?php echo e($unreadMsg); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('profile.info', ['user' => Auth::user()->name])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.info', ['user' => Auth::user()->name]))]); ?>
...
<?php /**PATH C:\Users\alekk\Desktop\PROJEKTI\chat-app\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>