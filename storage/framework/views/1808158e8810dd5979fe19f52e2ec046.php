                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="w-36 h-36 rounded-full overflow-hidden shadow-md border-4 border-indigo-500/50">
                            <img
                                id="avatarPreview"
                                src="<?php echo e($user->avatar ? asset('storage/images/avatars/' . $user->avatar) : asset('storage/images/avatars/default-avatar.png')); ?>"
                                alt="User Avatar"
                    ...
                    <div class="flex-1 w-full">
                        <form action="<?php echo e(route('profile.avatar')); ?>" method="POST" enctype="multipart/form-data"
                              class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <div>
...
<?php endif; ?>
<?php /**PATH C:\Users\alekk\Desktop\PROJEKTI\chat-app\resources\views/profile/edit.blade.php ENDPATH**/ ?>